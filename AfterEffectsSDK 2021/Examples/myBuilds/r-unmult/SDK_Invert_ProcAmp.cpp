	...
	PF_PreRenderExtra	*extraP)
{
	...
	if (infoP) {
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, RELIGHTING_CLAMP, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
