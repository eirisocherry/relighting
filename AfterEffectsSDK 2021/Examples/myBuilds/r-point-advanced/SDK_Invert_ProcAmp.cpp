	...
	PF_PreRenderExtra	*extraP)
{
	...
	if (infoP) {
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_1, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[0] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_1, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[0] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_1, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[0] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_2, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[1] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_2, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[1] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_2, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[1] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_3, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[2] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_3, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[2] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_3, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[2] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_4, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[3] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_4, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[3] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_4, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[3] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_5, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[4] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_5, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[4] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_5, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[4] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_6, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[5] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_6, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[5] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_6, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[5] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_7, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[6] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_7, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[6] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_7, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[6] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_8, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[7] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_8, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[7] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_8, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[7] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_9, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[8] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_9, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[8] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_9, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[8] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_AMBIENT_FALLOFF_10, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->ambientFalloff[9] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_DIFFUSE_FALLOFF_10, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->diffuseFalloff[9] = static_cast<float>(cur_param.u.fs_d.value);
		...
		ERR(PF_CHECKOUT_PARAM(in_dataP, SLIDER_SPECULAR_FALLOFF_10, in_dataP->current_time, in_dataP->time_step, in_dataP->time_scale, &cur_param));
		infoP->specularFalloff[9] = static_cast<float>(cur_param.u.fs_d.value);
	...
	const char* inHostVersion)
{
	...
	result = PF_REGISTER_EFFECT(
		...
		"r-point-advanced", // Name
		"ADBE r-point-advanced", // Match Name
		"Rikki", // Category
